...
encryptedData = function (text, key, iv) {
    ...
    // return text.ciphertext.toString() // 输出hex格式
    return text.toString()              // 输出base64格式
}

decryptedData = function (data, key, iv) {
    key = CryptoJS.enc.Utf8.parse(key)
    out = CryptoJS.AES.decrypt(data, key, {
        iv: CryptoJS.enc.Utf8.parse(iv),
        mode: CryptoJS.mode.CBC,
        padding: CryptoJS.pad.ZeroPadding
    })
...
function get_w(e, key, iv = '0000000000000000') {
    var c = encryptedData(e, key, iv).ciphertext.toString()
    var u = new vwBb()["encrypt"](i)
    console.log(c)
    // return c + u
    return c + ""
}
