...
function AcsToken(url, ua, key) {
    ...
    return ts_1 + '_' + ts_0 + '_' + AES_Encrypt(word, key)
}
...
console.log(AcsToken(url, ua, key))
...
// >>>0x10&0xff]^
// >>> 0x10 & 0xff] ^
key = "6A879D2D22CC4808"
iv = "636014d173e04409"

key = '36413837394432443232434334383038'
iv = '36333630313464313733653034343039'
