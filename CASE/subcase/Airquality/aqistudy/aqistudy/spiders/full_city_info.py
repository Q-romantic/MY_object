# -*- coding: utf-8 -*-
"""
@Time    : 2022/6/27  027 下午 14:06
@Author  : Jan
@File    : full_city_info.py
"""
...
proxy = {"http": f"http://{getip()}"}


def get_citys():
    city_url = 'https://www.aqistudy.cn/historydata/'
    html_info = requests.get(city_url, headers=headers, proxies=proxy)
