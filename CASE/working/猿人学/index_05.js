...
function _0x11a7a2(_0x193f00, _0x1cfe89) {
    ...
    for (_0x1badc3 = 0x0; _0x1badc3 < _0x193f00[_$UH[0x6c]]; _0x1badc3 += _0x42fb36)
        ...
        _0x257ec6 = _0x48d200(_0x257ec6, _0x3e0c38, _0xdb4d2c, _0x1724c5, _0x193f00[_0x1badc3 + 0x1], 0xc, vala),
        ...
        _0x1724c5 = _0x3180ec(_0x1724c5, _0x257ec6, _0x3e0c38, _0xdb4d2c, _0x193f00[_0x1badc3 + 0xf], 0xe, valb),
        _0xdb4d2c = _0x3180ec(_0xdb4d2c, _0x1724c5, _0x257ec6, _0x3e0c38, _0x193f00[_0x1badc3 + 0x4], 0x14, valc),
...
for (i=0; i<4; i++){
    var shorttimestamp = Date.parse(new Date()) - 1000*(4-i);
    var str1 = _0x474032(shorttimestamp);
    str = str1 + ',' + str
}
times = 1;
var timestamp=new Date().getTime();
var cookie_m = _0x474032(timestamp);
var key = str + cookie_m;
var CryptoJS = require("crypto-js");

_$Tk = CryptoJS;

_$Ww = _$Tk["enc"]["Utf8"]["parse"](key);
...
_0x4e96b4['_$qF'] = CryptoJS['enc']['Utf8']["parse"]((new Base64().encode(timestamp + '')+",")['slice'](0x0, 0x10));
...
function result(){
    var cookie_R = _0x29dd83["toString"]();
    return timestamp + '|' + cookie_m + '|' + cookie_R
}
console.log(result());
